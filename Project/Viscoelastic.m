...
Viscosity=logspace(-5,0,10); %Vector for substrate viscosity
events=1e4; %total events that will be siViscositylated

%Initialization of vectors
avg_retro=zeros(1,length(Viscosity));  %Vector to store Retrograde Flow rate
avg_trac=zeros(1,length(Viscosity));   %Vector to store mean traction force
