...
function build_data_dictionary()
    ...
    Km_aspartate = 1.54E-4 #metabolite concentration of aspartate
    Km_fumarate = 5.3E-3 #metabolite concentration of fumarate
    Km_arginine_v5 = 3E-3#metabolite concentration of arginine for v2
    Km_arginine_v3 = 1.55E-3 #metabolite concentration of arginine for v3
    Km_ornithine = 1.6E-3 #metabolite concentration of Ornithine (Saccharomyces cerevisiae)
    Km_ATP = 3.92E-4 #metabolite concentration of ATP (Mus musculus)
